...
const Aceternity = () => {
  // Container animation to control the infinite sequence
      ...
      >
        ...
        >
          ...
          <motion.path
            ...
            animate={{
              clipPath: [
                "inset(0 0 100% 0)", // Start: empty from bottom
                "inset(0 0 0% 0)", // Fill top to bottom
                "inset(0 0 0% 0)", // Stay filled
                "inset(100% 0 0 0)", // Empty: start from bottom (hidden from top)
                "inset(0% 0 0 0)", // Fill bottom to top
                "inset(0 0 0% 0)", // Stay filled
                "inset(0 0 100% 0)", // Reset
              ],
            }}
            transition={{
              duration: 8,
